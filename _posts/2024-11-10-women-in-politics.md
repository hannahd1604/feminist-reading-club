...
subtitle: "Does it matter who holds power if the room stays hostile?"
date: 2024-11-10
---
...
<ol class="structure-list">
  ...
  <li>Media coverage and double standards
    <ul>
      <li>How female politicians are covered differently: appearance, tone, personal lives</li>
      <li>What male politicians get away with that women cannot</li>
    </ul>
  </li>
  <li>Violence and harassment in political life
    <ul>
      <li>Online harassment and its effects on who decides to run</li>
      <li>Physical threats against female politicians</li>
    </ul>
  </li>
  <li>Does it matter? The harder question
    <ul>
      <li>Does having more women in office lead to better outcomes for women?</li>
      <li>Or does systemic pressure to conform mean women in power often reproduce the same structures?</li>
    </ul>
  </li>
</ol>
