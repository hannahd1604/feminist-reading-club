...
subtitle: "Who gets left out when we talk about women's rights?"
date: 2024-03-17
---
...
<div class="materials-block">
  ...
  <ul class="materials-list">
    ...
    <li>Paper section 5 on feminism, pages 5–7 <span class="dur">(paper · attached)</span></li>
  </ul>
</div>
<div class="materials-block">
  <div class="materials-label">Supplementary</div>
  <ul class="materials-list">
    <li><a href="https://open.spotify.com/episode/2hbR2X1aekDsIPY5AikiuY" target="_blank" rel="noopener">Vulnera podcast</a> on feminism (Dutch) <span class="dur">(Spotify)</span></li>
    <li><a href="https://www.youtube.com/watch?v=2CmX6U5C4r0" target="_blank" rel="noopener">Trad wives documentary</a> (Dutch) <span class="dur">(YouTube)</span></li>
  </ul>
</div>

<div class="section-head" id="structure">Session structure</div>
<ol class="structure-list">
  <li>What does feminism mean to you?
    <ul>
      <li>Your own definition before the historical one (Charles Fourier, 1837)</li>
  ...
  <li>Open questions
    <ul>
      <li>Is "girl boss" feminism a product of third-wave thinking?</li>
      <li>Is "feminism" still the right term, or has it been co-opted?</li>
      <li>How does the gender voting gap challenge assumptions about solidarity?</li>
    </ul>
  </li>
</ol>
